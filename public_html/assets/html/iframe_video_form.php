<html>
  ...
  <body>
	...
	<form id="add_video_form" class="input_form" action="http://localhost/~media/swarmtvNet/public_html/index.php/elements/add" method="post" enctype="multipart/form-data">
	  <h2>New Video</h2>
	  ...
	  <input type="hidden" name="mediaType" id="mediaType" value="audio"/>
