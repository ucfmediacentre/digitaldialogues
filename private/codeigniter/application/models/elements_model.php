...
class Elements_model extends CI_Model {
	...
	public function add_recording($group = "public", $page = "sandpit")
	{
		...
		//Public server's URL
		$createOgvVersion = "/usr/local/bin/ffmpeg2theora -async 1 /usr/local/WowzaStreamingEngine/content/webcamrecording.flv -o /var/www/assets/video/".$unique_name . ".ogv";
		$execute = shell_exec($createOgvVersion);
