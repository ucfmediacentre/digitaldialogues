<!DOCTYPE html>
  ...
  <body>
	...
	<p>Thank you for joining the Digital Dialogues community.</p><p><a href="<?php echo base_url() ?>index.php/pages/view/community/home">community : Home</a>&nbsp;|&nbsp;<a href="<?php echo base_url() ?>index.php/pages/view/community/sandpit">Sandpit</a>&nbsp;|&nbsp;<a href="<?php echo base_url() ?>index.php/pages/view/community/help">Help</a>&nbsp;|&nbsp;<a href="<?php echo base_url() ?>index.php/verifylogin/index/pages/community/home">Log In</a></p>
