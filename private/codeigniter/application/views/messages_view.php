...
<!DOCTYPE html>
    ...
    <body>
		...
		<div id="main_pages_wrapper">
			...
			<br />
			<a href="<?php echo base_url().'index.php/messages/view/'.$username ?>">View new messages</a>&nbsp;|&nbsp;<a href="<?php echo base_url().'index.php/messages/view_all/'.$username ?>">View all messages</a>
		</div>
