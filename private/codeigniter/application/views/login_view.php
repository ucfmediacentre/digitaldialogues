<!DOCTYPE html>
  ...
  <body>
    ...
    <div id="main_pages_wrapper">
	  ...
	  <br />
	  <a href="<?php echo base_url(); ?>index.php/pages/view/community/home">Community : Home</a>&nbsp;|&nbsp;<a href="<?php echo base_url(); ?>index.php/pages/view/community/sandpit">Sandpit</a>&nbsp;|&nbsp;<a href="<?php echo base_url(); ?>index.php/pages/view/community/help">Help</a>&nbsp;|&nbsp;<a href="<?php echo base_url(); ?>index.php/register/index/pages/<?php echo $group ?>/<?php echo $title; ?>">Register</a>
    </div>
    </form>
	<script>
